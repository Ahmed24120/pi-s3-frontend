...
>
  Login
        ...
        {/* RIGHT SIDE (purple) */}
        <div className="w-1/2 bg-gradient-to-br from-purple-400 to-purple-600 text-white p-10 flex flex-col justify-center rounded-l-[80px]">
          <h1 className="text-4xl font-bold mb-3">Hello, Welcome!</h1>
          <p className="text-lg opacity-90 mb-8">Please log in to continue</p>

          <button
            type="button"
            onClick={goToProfessor}
        ...
        {(switching || revealing) && (
          <motion.div
            ...
            transition={T}
            onAnimationComplete={() => {
              if (switching) router.push("/professor/login");
            }}
          />
        )}
      </div>
